function val = sim_cljs(n,p,k,sep,num,mode,cutoff)

%
% valor = sim_cljs(num_data,dimension,num_clusters,
%                  separation,num_replications,mode,cutoff)
%
% Simulation experiment for the Jones y Sibson cluster identification
% procedure
%
